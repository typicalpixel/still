defmodule StillWeb.Telemetry do
  use Supervisor
  ...
  @doc """
  Returns the list of telemetry metrics collected by the application.
  """
  def metrics do
    [
      # Phoenix Metrics
      ...
      # Database Metrics
      summary("still.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("still.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("still.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("still.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("still.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
